package com.synertone.imitglide.load;
...
import com.synertone.imitglide.cache.recycle.ActiveResource;
import com.synertone.imitglide.cache.recycle.DiskCache;
import com.synertone.imitglide.cache.recycle.Resource;
import com.synertone.imitglide.core.GlideContext;
import com.synertone.imitglide.core.request.ResourceCallback;
...
public class Engine implements MemoryCache.ResourceRemoveListener, Resource.ResourceListener,
    ...
    public LoadStatus load(GlideContext glideContext, Object model, int width, int height,
        ...
        if (null != resource) {
            ...
            resource.acquire();
            resource.setListener(engineKey, this);
            cb.onResourceReady(resource);
            return null;
        }
